...
import org.apache.rocketmq.exporter.service.DashboardCollectService;
...
public class DashboardCollectTask {
    ...
    private final static TopicCollector topicCollector = new TopicCollector();
    @Resource
...
//                dashboardCollectService.getTopicMap().put(topic, list);
    ...
    public void bTask(){
        ...
        Date date = new Date();
        System.out.println(date.toString() +"*********B任务每5秒执行一次进入测试");
    }
